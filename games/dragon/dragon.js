...
import { initTelegram, haptic, showBackButton, backToHubOnResume } from '../../js/tg.js?v14';
import { registerTexts, registerItemTexts, t, applyStaticTexts, locale } from '../../js/i18n-hook.js?v14';

import { CONFIG, feedCost, xpNeeded, rewardForLevel } from './config.js?v14';
import { SLOTS, KATALOG, AURAS, ISLANDS, RARITIES, ada as adaTemasi } from './data.js?v14';
import { bakiyeOku, harca } from './economy.js?v14';
import { oyuncuyuYukle, oyuncuyuKaydet, aktifEjderha, sahipMi, dolabaEkle,
         adaSahipMi, adaEkle } from './model.js?v14';
import { dragonSvg, headSvg, faceSvg, HEAD_BOX } from './art.js?v14';
import { ITEM_TEXTS } from './i18n-items.js?v14';
import { createIsland } from './island.js?v14';
