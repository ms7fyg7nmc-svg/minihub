...
import { submitScore, addPoints, getBest, saveState, loadState, clearState } from '../../js/store.js?v40';
import { registerTexts, t, applyStaticTexts } from '../../js/i18n-hook.js?v40';
