...
import { submitScore, addPoints, getBest, saveState, loadState, clearState } from '../../js/store.js?v32';
import { registerTexts, t, applyStaticTexts } from '../../js/i18n-hook.js?v32';
