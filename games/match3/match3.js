...
import { initTelegram, haptic, showBackButton, backToHubOnResume } from '../../js/tg.js?v52';
import { submitScore, addPoints, getBest, saveState, loadState, clearState, settleAbandonedRun } from '../../js/store.js?v52';
import { registerTexts, t, applyStaticTexts, locale } from '../../js/i18n-hook.js?v52';
import { SFX, soundToggleHtml, mountSoundToggle } from '../../js/audio.js?v52';
