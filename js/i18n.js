...
const DICT = {
  en: {
    ...
    'snake.readyText': "Swipe in any direction to steer. Don't hit the walls or yourself.",
  ...
  tr: {
    ...
    'snake.readyText': 'Yön vermek için parmağını kaydır. Duvara ve kendine çarpma.',
  ...
  es: {
    ...
    'snake.readyText': 'Desliza en cualquier dirección para girar. No choques con los muros ni contigo.',
  ...
  ru: {
    ...
    'snake.readyText': 'Проведи пальцем в любую сторону, чтобы повернуть. Не врежься в стену или в себя.',
